package com.example.uxiang.hw3;
...
public class MainActivity extends AppCompatActivity {
    ...
    private AdapterView.OnItemSelectedListener spnOnItemSelect = new AdapterView.OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            switch (selectedSex) {
                case "male": mRadBtnAgeRange1.setText("小於30歲");
                    mRadBtnAgeRange2.setText("30~40歲");
                    mRadBtnAgeRange3.setText("大於40歲");
                    break;
                case "female":
                    mRadBtnAgeRange1.setText("小於28歲");
                    mRadBtnAgeRange2.setText("28~35歲");
                    mRadBtnAgeRange3.setText("大於35歲");
            }
        }
